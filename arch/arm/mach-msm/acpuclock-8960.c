...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	...
	[4]  = { {  540000, HFPLL, 2, 0, 0x28 }, 1050000, 1050000, 3 },
	[5]  = { {  594000, HFPLL, 1, 0, 0x16 }, 1050000, 1050000, 3 },
	[6]  = { {  648000, HFPLL, 1, 0, 0x18 }, 1050000, 1050000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0, 0x1A }, 1050000, 1050000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0, 0x1C }, 1150000, 1150000, 5 },
	[9]  = { {  810000, HFPLL, 1, 0, 0x1E }, 1150000, 1150000, 5 },
	...
	[21] = { { 1458000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 6 },
};

static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(2),   975000 },
	...
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(10), 1100000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(11), 1100000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(12), 1125000 },
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(2),   875000 },
	...
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(10), 1000000 },
