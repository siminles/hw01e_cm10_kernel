...
#define PRODUCT_NVRAM_PATH  "/vendor/firmware/nvram_%s.txt"
...
#endif
	/*if netdev is "p2p-wlan0" (0 != ifindex) and it's deleted (1 != g_p2p_intf_flag),
	we don't send command to the firmware and just return.*/
