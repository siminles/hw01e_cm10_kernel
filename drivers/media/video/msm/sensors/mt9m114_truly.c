...
#define SENSOR_NAME "mt9m114_truly"
#define PLATFORM_DRIVER_NAME "msm_camera_mt9m114_truly"
#define mt9m114_truly_obj mt9m114_truly_##obj

/* Sysctl registers */
#define MT9M114_TRULY_COMMAND_REGISTER          0x0080
#define MT9M114_TRULY_COMMAND_REGISTER_APPLY_PATCH    (1 << 0)
#define MT9M114_TRULY_COMMAND_REGISTER_SET_STATE      (1 << 1)
#define MT9M114_TRULY_COMMAND_REGISTER_REFRESH        (1 << 2)
#define MT9M114_TRULY_COMMAND_REGISTER_WAIT_FOR_EVENT (1 << 3)
#define MT9M114_TRULY_COMMAND_REGISTER_OK             (1 << 15)

DEFINE_MUTEX(mt9m114_truly_mut);

static struct msm_sensor_ctrl_t mt9m114_truly_s_ctrl;

static struct msm_camera_i2c_reg_conf mt9m114_truly_960p_settings[] = {
	{0xdc00, 0x50, MSM_CAMERA_I2C_BYTE_DATA, MSM_CAMERA_I2C_CMD_WRITE},
	//{MT9M114_TRULY_COMMAND_REGISTER, MT9M114_TRULY_COMMAND_REGISTER_SET_STATE,
	//	MSM_CAMERA_I2C_UNSET_WORD_MASK, MSM_CAMERA_I2C_CMD_POLL},
	{MT9M114_TRULY_COMMAND_REGISTER, (MT9M114_TRULY_COMMAND_REGISTER_OK |
		MT9M114_TRULY_COMMAND_REGISTER_SET_STATE), MSM_CAMERA_I2C_WORD_DATA,
...
static struct msm_camera_i2c_reg_conf mt9m114_truly_recommend_settings[] = {
...
// 直到为0或者   50ms以上
{MT9M114_TRULY_COMMAND_REGISTER, MT9M114_TRULY_COMMAND_REGISTER_SET_STATE, MSM_CAMERA_I2C_UNSET_WORD_MASK, MSM_CAMERA_I2C_CMD_POLL},
//{ DELAY,  { 50 } },
...
static struct v4l2_subdev_info mt9m114_truly_subdev_info[] = {
	{
...
static struct msm_camera_i2c_reg_conf mt9m114_truly_config_change_settings[] = {
...
static void mt9m114_truly_stop_stream(struct msm_sensor_ctrl_t *s_ctrl) {}

static struct msm_camera_i2c_conf_array mt9m114_truly_init_conf[] = {
	{mt9m114_truly_recommend_settings,
	ARRAY_SIZE(mt9m114_truly_recommend_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_config_change_settings,
	ARRAY_SIZE(mt9m114_truly_config_change_settings),
	0, MSM_CAMERA_I2C_WORD_DATA},
};

static struct msm_camera_i2c_conf_array mt9m114_truly_confs[] = {
	{mt9m114_truly_960p_settings,
	ARRAY_SIZE(mt9m114_truly_960p_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
};

static struct msm_camera_i2c_reg_conf mt9m114_truly_saturation[][1] = {
	{{0xCC12, 0x00},},
	{{0xCC12, 0x1A},},
	{{0xCC12, 0x34},},
	{{0xCC12, 0x4E},},
...
static struct msm_camera_i2c_reg_conf mt9m114_truly_refresh[] = {
	//{MT9M114_TRULY_COMMAND_REGISTER, MT9M114_TRULY_COMMAND_REGISTER_REFRESH,
	//	MSM_CAMERA_I2C_UNSET_WORD_MASK, MSM_CAMERA_I2C_CMD_POLL},
	{MT9M114_TRULY_COMMAND_REGISTER, (MT9M114_TRULY_COMMAND_REGISTER_OK |
		MT9M114_TRULY_COMMAND_REGISTER_REFRESH), MSM_CAMERA_I2C_WORD_DATA,
		MSM_CAMERA_I2C_CMD_WRITE},
	//{MT9M114_TRULY_COMMAND_REGISTER, MT9M114_TRULY_COMMAND_REGISTER_REFRESH,
	//	MSM_CAMERA_I2C_UNSET_WORD_MASK, MSM_CAMERA_I2C_CMD_POLL},
	//{MT9M114_TRULY_COMMAND_REGISTER, MT9M114_TRULY_COMMAND_REGISTER_OK,
...
static struct msm_camera_i2c_conf_array mt9m114_truly_saturation_confs[][2] = {
	{{mt9m114_truly_saturation[0],
		ARRAY_SIZE(mt9m114_truly_saturation[0]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[1],
		ARRAY_SIZE(mt9m114_truly_saturation[1]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[2],
		ARRAY_SIZE(mt9m114_truly_saturation[2]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[3],
		ARRAY_SIZE(mt9m114_truly_saturation[3]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[4],
		ARRAY_SIZE(mt9m114_truly_saturation[4]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[5],
		ARRAY_SIZE(mt9m114_truly_saturation[5]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[6],
		ARRAY_SIZE(mt9m114_truly_saturation[6]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[7],
		ARRAY_SIZE(mt9m114_truly_saturation[7]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[8],
		ARRAY_SIZE(mt9m114_truly_saturation[8]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[9],
		ARRAY_SIZE(mt9m114_truly_saturation[9]), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
	{{mt9m114_truly_saturation[10],
		ARRAY_SIZE(mt9m114_truly_saturation[10]),
		0, MSM_CAMERA_I2C_WORD_DATA},
	{mt9m114_truly_refresh,
		ARRAY_SIZE(mt9m114_truly_refresh), 0, MSM_CAMERA_I2C_WORD_DATA},},
};

static int mt9m114_truly_saturation_enum_map[] = {
...
static struct msm_camera_i2c_enum_conf_array mt9m114_truly_saturation_enum_confs = {
	.conf = &mt9m114_truly_saturation_confs[0][0],
	.conf_enum = mt9m114_truly_saturation_enum_map,
	.num_enum = ARRAY_SIZE(mt9m114_truly_saturation_enum_map),
	.num_index = ARRAY_SIZE(mt9m114_truly_saturation_confs),
	.num_conf = ARRAY_SIZE(mt9m114_truly_saturation_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};

struct msm_sensor_v4l2_ctrl_info_t mt9m114_truly_v4l2_ctrl_info[] = {
	{
		.ctrl_id = V4L2_CID_SATURATION,
		.min = MSM_V4L2_SATURATION_L0,
		.max = MSM_V4L2_SATURATION_L10,
		.step = 1,
		.enum_cfg_settings = &mt9m114_truly_saturation_enum_confs,
		.s_v4l2_ctrl = msm_sensor_s_ctrl_by_enum,
	},
};

static struct msm_sensor_output_info_t mt9m114_truly_dimensions[] = {
	{
		.x_output = 0x500,
		.y_output = 0x3C0,
...
static struct msm_camera_csid_vc_cfg mt9m114_truly_cid_cfg[] = {
	{0, CSI_YUV422_8, CSI_DECODE_8BIT},
	{1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params mt9m114_truly_csi_params = {
	.csid_params = {
		.lane_assign = 0xe4,
		.lane_cnt = 1,
		.lut_params = {
			.num_cid = 2,
			.vc_cfg = mt9m114_truly_cid_cfg,
		},
	},
	.csiphy_params = {
		.lane_cnt = 1,
...
static struct msm_camera_csi2_params *mt9m114_truly_csi_params_array[] = {
	&mt9m114_truly_csi_params,
	&mt9m114_truly_csi_params,
};

static struct msm_sensor_output_reg_addr_t mt9m114_truly_reg_addr = {
	.x_output = 0xC868,
	.y_output = 0xC86A,
...
static struct msm_sensor_id_info_t mt9m114_truly_id_info = {
	.sensor_id_reg_addr = 0x0,
	.sensor_id = 0x2481,
};

static const struct i2c_device_id mt9m114_truly_i2c_id[] = {
	{SENSOR_NAME, (kernel_ulong_t)&mt9m114_truly_s_ctrl},
	{ }
};

static struct i2c_driver mt9m114_truly_i2c_driver = {
	.id_table = mt9m114_truly_i2c_id,
...
static struct msm_camera_i2c_client mt9m114_truly_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_WORD_ADDR,
};

int32_t mt9m114_truly_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
    int rc;
	int reset_gpio;
	...
	rc = gpio_request(reset_gpio,"mt9m114_truly");
	if (rc) 
	{
...
int32_t mt9m114_truly_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	int reset_gpio;
...
int mt9m114_truly_sensor_set_effect (struct msm_sensor_ctrl_t *s_ctrl, char effect)
{
	int rc = 0;
...
int mt9m114_truly_sensor_set_whitebalance (struct msm_sensor_ctrl_t * s_ctrl,char wb)
{
     long rc = 0;
...
static int __init mt9m114_truly_init_module(void)
{
	return i2c_add_driver(&mt9m114_truly_i2c_driver);
}

static struct v4l2_subdev_core_ops mt9m114_truly_subdev_core_ops = {
...
static struct v4l2_subdev_video_ops mt9m114_truly_subdev_video_ops = {
	.enum_mbus_fmt = msm_sensor_v4l2_enum_fmt,
};

static struct v4l2_subdev_ops mt9m114_truly_subdev_ops = {
	.core = &mt9m114_truly_subdev_core_ops,
	.video  = &mt9m114_truly_subdev_video_ops,
};

static struct msm_sensor_fn_t mt9m114_truly_func_tbl = {
	.sensor_start_stream = msm_sensor_start_stream,
	.sensor_stop_stream = mt9m114_truly_stop_stream,
	.sensor_setting = msm_sensor_setting,
	.sensor_set_sensor_mode = msm_sensor_set_sensor_mode,
	.sensor_mode_init = msm_sensor_mode_init,
	.sensor_get_output_info = msm_sensor_get_output_info,
	.sensor_config = msm_sensor_config,
	.sensor_power_up = mt9m114_truly_sensor_power_up,
	.sensor_power_down = mt9m114_truly_sensor_power_down,
	.sensor_set_whitebalance_yuv = mt9m114_truly_sensor_set_whitebalance,
    .sensor_set_effect_yuv =  mt9m114_truly_sensor_set_effect,
};

static struct msm_sensor_reg_t mt9m114_truly_regs = {
	.default_data_type = MSM_CAMERA_I2C_BYTE_DATA,
	.start_stream_conf = mt9m114_truly_config_change_settings,
	.start_stream_conf_size = ARRAY_SIZE(mt9m114_truly_config_change_settings),
	.init_settings = &mt9m114_truly_init_conf[0],
	.init_size = ARRAY_SIZE(mt9m114_truly_init_conf),
	.mode_settings = &mt9m114_truly_confs[0],
	.output_settings = &mt9m114_truly_dimensions[0],
	.num_conf = ARRAY_SIZE(mt9m114_truly_confs),
};

static struct msm_sensor_ctrl_t mt9m114_truly_s_ctrl = {
	.msm_sensor_reg = &mt9m114_truly_regs,
	.msm_sensor_v4l2_ctrl_info = mt9m114_truly_v4l2_ctrl_info,
	.num_v4l2_ctrl = ARRAY_SIZE(mt9m114_truly_v4l2_ctrl_info),
	.sensor_i2c_client = &mt9m114_truly_sensor_i2c_client,
	.sensor_i2c_addr = 0xBA,
	.sensor_output_reg_addr = &mt9m114_truly_reg_addr,
	.sensor_id_info = &mt9m114_truly_id_info,
	.cam_mode = MSM_SENSOR_MODE_INVALID,
	.csi_params = &mt9m114_truly_csi_params_array[0],
	.msm_sensor_mutex = &mt9m114_truly_mut,
	.sensor_i2c_driver = &mt9m114_truly_i2c_driver,
	.sensor_v4l2_subdev_info = mt9m114_truly_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(mt9m114_truly_subdev_info),
	.sensor_v4l2_subdev_ops = &mt9m114_truly_subdev_ops,
	.func_tbl = &mt9m114_truly_func_tbl,
};

module_init(mt9m114_truly_init_module);
